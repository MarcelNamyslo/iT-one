...
all_points_df = pd.read_csv("prediction_data/predicted_data_2045.csv")  # ✅ Deine CSV mit 1.200 Datenpunkten pro Jahr
...
heat_data = list(zip(all_points_gdf.Latitude, all_points_gdf.Longitude, all_points_gdf["Classification"]))
...
HeatMap(
    ...
    gradient={
        ...
        str(0.9): "yellow", # Höhere Werte → Gelb
